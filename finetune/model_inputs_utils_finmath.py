...
def prepare_pot_model_input2(example):
    system_input = '''You are a financial expert, you are supposed to generate a Python program to answer the given question. Please store the result of the question in the 'ans' variable. Here is an example of the Python program:
```python
revenue = 600000
